    ...
    public partial class intial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 7, 9, 18, 59, 21, 290, DateTimeKind.Local).AddTicks(6804), "Kalem 1", 100m, 20, null },
                    { 2, 1, new DateTime(2022, 7, 9, 18, 59, 21, 290, DateTimeKind.Local).AddTicks(6814), "Kalem 2", 200m, 30, null },
                    { 3, 1, new DateTime(2022, 7, 9, 18, 59, 21, 290, DateTimeKind.Local).AddTicks(6867), "Kalem 3", 600m, 60, null },
                    { 4, 2, new DateTime(2022, 7, 9, 18, 59, 21, 290, DateTimeKind.Local).AddTicks(6869), "Kitap 1", 600m, 60, null },
                    { 5, 1, new DateTime(2022, 7, 9, 18, 59, 21, 290, DateTimeKind.Local).AddTicks(6869), "Kitap 2", 6600m, 320, null }
                });
